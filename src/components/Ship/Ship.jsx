    ...
    <>
      <div className="side-padding my-[40px] pb-2">
        ...
        <ul className="">
            ...
            <li className="sm:text-[33px] text-[20px]">4. Tracking numbers will be forwarded to customars</li>
            <li className="sm:text-[33px] text-[20px]">5. Our Agent will notify customer a week before shipment arrive Nigeria port on how to pick up barrel</li>
        </ul>
      </div>
    </>
  );
